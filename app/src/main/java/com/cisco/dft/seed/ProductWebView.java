...
/**
 * Opens a Protected WebView within the application by using ObSSOCookie
 **/
public class ProductWebView extends Activity {
	...
	/**
	 * Initializes the WebView for different authentication and grant types
	 */
	...
	/**
	 * Calls a method to refresh the cookie if expired
	 * 
	 */
	...
	private class MyCustomWebViewClient extends WebViewClient {
		...
		public void onPageFinished(WebView view, String url) {
			...
			if (!(AuthConstants.GRANT_TYPE
				...
				String webCookie = AuthUtils.getCookie(cookies, "ObSSOCookie=");
				if (webCookie != null
